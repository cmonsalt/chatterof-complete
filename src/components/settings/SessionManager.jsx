...
export default function SessionManager({ isOpen, onClose, modelId, editingSession = null }) {
  ...
  const loadAvailableMedias = async () => {
    try {
      // Obtener medias que NO tienen session_id (disponibles)
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      for (let i = 0; i < parts.length; i++) {
        ...
        // Marcar los medias como usados (asignarles session_id)
